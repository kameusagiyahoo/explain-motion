...
export function Workspace({ initialPlan }: { initialPlan: VideoPlan }) {
  ...
  async function generate() {
    ...
    try {
      ...
      const body: { plan?: VideoPlan; mode?: "mock" | "openai"; error?: string } = await response.json();
